      ...
      nav: [
        { text: 'Docs', link: '/getting-started/quick-start' },
        {
          ...
          items: [
            ...
            {
              text: 'Inspecting Findings',
              link: '/guides/inspecting-findings',
            },
        ...
        },
        {
          ...
          items: [
            { text: 'Overview', link: '/rules/' },
            {
              ...
              items: [
                {
                  text: 'required-layers',
                  link: '/rules/tile/required-layers',
                },
                {
                  text: 'required-properties',
                  link: '/rules/tile/required-properties',
                },
                {
                  text: 'coordinate-range',
                  link: '/rules/tile/coordinate-range',
                },
                { text: 'feature-count', link: '/rules/tile/feature-count' },
                {
                  text: 'layer-feature-count',
                  link: '/rules/tile/layer-feature-count',
                },
                ...
                {
                  text: 'hole-containment',
                  link: '/rules/tile/hole-containment',
                },
                {
                  text: 'self-intersection',
                  link: '/rules/tile/self-intersection',
                },
                {
                  text: 'degenerate-geometry',
                  link: '/rules/tile/degenerate-geometry',
                },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: 'sources-present',
                  link: '/rules/style/sources-present',
                },
                { text: 'layers-present', link: '/rules/style/layers-present' },
                {
                  text: 'layer-id-required',
                  link: '/rules/style/layer-id-required',
                },
                {
                  text: 'unique-layer-id',
                  link: '/rules/style/unique-layer-id',
                },
                { text: 'known-source', link: '/rules/style/known-source' },
                { text: 'zoom-range', link: '/rules/style/zoom-range' },
                {
                  text: 'no-deprecated-ref',
                  link: '/rules/style/no-deprecated-ref',
                },
              ],
            },
          ],
        },
        {
          ...
          items: [
            { text: 'Overview', link: '/architecture/overview' },
            {
              ...
              link: '/architecture/validation-pipeline',
            },
            { text: 'Rule Engine', link: '/architecture/rule-engine' },
            {
              text: 'Decoder & Diagnostics',
              link: '/architecture/decoder-diagnostics',
            },
          ],
        },
        {
          ...
          items: [
            {
              text: 'ADR-001: Why TileGuard Exists',
              link: '/decisions/adr-001-why-tileguard-exists',
            },
            {
              text: 'ADR-002: Local-First Processing',
              link: '/decisions/adr-002-local-first-processing',
            },
            {
              text: 'ADR-003: Rule-Based Architecture',
              link: '/decisions/adr-003-rule-based-architecture',
            },
            {
              text: 'ADR-004: Structured Diagnostics',
              link: '/decisions/adr-004-structured-diagnostics',
            },
            {
              text: 'ADR-005: Validation ≠ Visualization',
              link: '/decisions/adr-005-validation-visualization-separation',
            },
          ],
        },
        {
