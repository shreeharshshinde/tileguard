...
export function CapabilitiesSection(): JSX.Element {
  ...
  return (
    <section aria-label="Capabilities" className="relative flex w-full flex-col overflow-hidden py-24">
      {/* Section heading */}
      <div className="mb-14 flex flex-col items-center text-center px-6">
        ...
        <p className="mt-4 max-w-xl text-base text-[var(--tg-text-secondary)]">
          TileGuard ships with a complete suite of tools to inspect, diagnose, and validate your map tiles.
        </p>
      </div>
              ...
              <div className="relative z-10 flex h-full flex-col justify-between overflow-hidden rounded-[23px] bg-[#09090b] p-8 shadow-[inset_0_1px_0px_rgba(255,255,255,0.05)]">
                ...
                <div className="relative z-10 flex h-full flex-col">
                  ...
                  <div className="mb-10 flex items-start justify-between">
                    <div
                      className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-black ring-1 ring-white/10 shadow-[inset_0_1px_0px_rgba(255,255,255,0.1)] transition-all duration-500 group-hover:scale-110 group-hover:ring-[var(--tg-accent)]/40 group-hover:shadow-[0_0_20px_rgba(163,255,0,0.2)]"
                    >
                      <Icon className={`h-5 w-5 ${color} transition-colors group-hover:text-[var(--tg-accent)]`} aria-hidden="true" />
                    </div>
